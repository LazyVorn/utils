    ...
    <div class="lv_tree_element_wrap">
        <div class="lv_tree_element_table" v-for="info in treeData" :key="info[idName]">
            ...
            <div class="lv_tree_table_box" v-show="info.isShow">
                <TreeElement v-if="info.childNode" :treeData="info.childNode" :pIdName="pIdName" :choosedType="choosedType" :width="width" :treeLayer="treeLayer + 1" @getTrClick="getTrClick" :left="parseInt(left)+25" :order="order" :headData="headData" @getChooseBox="getChooseBox"></TreeElement>
            </div>
        </div>
    </div>
</template>
